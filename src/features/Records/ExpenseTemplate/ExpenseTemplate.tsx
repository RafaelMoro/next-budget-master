...
import { BankMovement, ExpenseDataResponse, CreateExpenseDataForm, CreateExpenseError, CreateExpensePayload, EditExpensePayload, IncomeExpenseSchema } from "@/shared/types/records.types"
...
export const ExpenseTemplate = ({
  ...
  } = useMutation<ExpenseDataResponse, CreateExpenseError, CreateExpensePayload>({
  ...
  } = useMutation<ExpenseDataResponse, CreateExpenseError, EditExpensePayload>({
