...
export const RecordEntry = ({ record }: AccountEntryProps) => {
  ...
  return (
    <article className="p-2 rounded-lg grid grid-rows-3 grid-view-records gap-x-2 transition-colors duration-200 hover:bg-gray-200 dark:hover:bg-gray-800 cursor-pointer">
